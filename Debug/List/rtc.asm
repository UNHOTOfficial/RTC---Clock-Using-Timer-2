...
_0x0:
	.DB  0x50,0x4D,0x0,0x41,0x4D,0x0,0x54,0x69
	.DB  0x6D,0x65,0x3A,0x20,0x25,0x30,0x32,0x64
	.DB  0x3A,0x25,0x30,0x32,0x64,0x3A,0x25,0x30
	.DB  0x32,0x64,0x25,0x73,0x0,0x41,0x6C,0x61
	.DB  0x72,0x6D,0x3A,0x20,0x25,0x30,0x32,0x64
	.DB  0x3A,0x25,0x30,0x32,0x64,0x3A,0x25,0x30
	.DB  0x32,0x64,0x0,0x41,0x6C,0x61,0x72,0x6D
	.DB  0x3A,0x20,0x4E,0x6F,0x74,0x20,0x73,0x65
	.DB  0x74,0x0,0x53,0x65,0x74,0x20,0x54,0x69
	.DB  0x6D,0x65,0x3A,0x0,0x48,0x6F,0x75,0x72
	.DB  0x3A,0x20,0x25,0x30,0x32,0x64,0x0,0x4D
	.DB  0x69,0x6E,0x75,0x74,0x65,0x3A,0x20,0x25
	.DB  0x30,0x32,0x64,0x0,0x53,0x65,0x63,0x6F
	.DB  0x6E,0x64,0x3A,0x20,0x25,0x30,0x32,0x64
	.DB  0x0,0x54,0x69,0x6D,0x65,0x20,0x53,0x61
	.DB  0x76,0x65,0x64,0x0,0x53,0x65,0x74,0x20
	.DB  0x41,0x6C,0x61,0x72,0x6D,0x3A,0x0,0x41
	.DB  0x6C,0x61,0x72,0x6D,0x20,0x53,0x65,0x74
	.DB  0x0
_0x2040003:
	.DB  0x80,0xC0
...
; 0000 0034     timer2_overflow_count++;
	LDI  R26,LOW(_timer2_overflow_count_S0000000000)
	LDI  R27,HIGH(_timer2_overflow_count_S0000000000)
	CALL SUBOPT_0x0
; 0000 0035     if(timer2_overflow_count >= 1)  // One second has passed
	LDS  R26,_timer2_overflow_count_S0000000000
	LDS  R27,_timer2_overflow_count_S0000000000+1
	SBIW R26,1
	BRLO _0x3
; 0000 0036     {
; 0000 0037         timer2_overflow_count = 0;
	LDI  R30,LOW(0)
	STS  _timer2_overflow_count_S0000000000,R30
	STS  _timer2_overflow_count_S0000000000+1,R30
; 0000 0038         s++;
	INC  R7
; 0000 0039         if(s >= 60)
	LDI  R30,LOW(60)
...
;OPTIMIZER ADDED SUBROUTINE, CALLED 4 TIMES, CODE SIZE REDUCTION:3 WORDS
SUBOPT_0x8:
	LDI  R26,LOW(_clock_buffer)
	LDI  R27,HIGH(_clock_buffer)
	JMP  _lcd_puts

;OPTIMIZER ADDED SUBROUTINE, CALLED 4 TIMES, CODE SIZE REDUCTION:3 WORDS
SUBOPT_0x9:
	LDI  R30,LOW(_alarm_buffer)
	LDI  R31,HIGH(_alarm_buffer)
	ST   -Y,R31
	ST   -Y,R30
	RET
...
SUBOPT_0xB:
	LDI  R26,LOW(_alarm_buffer)
	LDI  R27,HIGH(_alarm_buffer)
	JMP  _lcd_puts
